	...
	// message board routes ===============================================================
		 ...
		 app.post('/admin', (req, res) => {
		  console.log(req.body)
			db.collection('games').save({value: Number(req.body.Revenue),
		 ...
		 app.put('/updateGame', (req, res) => {
		  ...
		  .findOneAndUpdate({},
			...
			upsert: true
				...
				result = {WinCheck:"Player Wins with Green"
				}
		 ...
		 else if (random >= 2 && random <= 19 && req.body.color === 'black') {
		  db.collection('games')
		.findOneAndUpdate({},
			{ 
		   $inc: {
		...
		else if (random >= 20 && random <= 37 && req.body.color === 'red') {
		db.collection('games')
	  .findOneAndUpdate({},
		  { 
		 $inc: {
		 ...
		 res.send(result)
			...
			.findOneAndUpdate({},
			 ...
			 (err, result) => {
			  ...
			  result = {WinCheck:"Player Lost, Casino earns money"}
